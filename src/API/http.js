...
export default [
  ...
  {
    use:'微信支付',
    url:'/mxPayController/weixinSuccess',
    params : [`Var param = { ordered:订单号}`],
    result : '{status:200,msg:success,data:true或者false}',
    des :[`无`]
  },
  {
    use:'微信支付',
    url:'/mxPayController/weChatUnifiedorder',
    params : [`Var param = { ordered:订单号}`],
  ...
  {
    use:'支付宝支付',
    url:'/zzb-dream/alipayController/alipayPcWapPay',
    params : [`Var param = { ordered:订单号}`],
    result :[`失败:{code:500,data:null}成功:{200,data:[]`],
    des :[`无`]
  },
    {
    use:'购物车商品移动到想玩',
    url:'/mxUserPlayController/moveToPlay',
    params : [`Var param={goodsId:xxxx}`],
    result :[`失败:情况1{status:500,data:商品不存在!}
情况1{status:500,data:您已经添加过该商品了!}
成功:{status:200,data:移动成功!}
 `],
    des :[`输入参数goodsId:商品Id`]
  },
    {
    use:'查询二手游戏',
    url:'/gameBaseInfoController/findNewGame',
    params : [`Var param = { curIndex:'1',pageSize:'5',gameType:’ secondHand’} `],
    result :[` 失败:{code:500,data:null}成功:{200,`],
    des :[`POST请求`]
  },
    {
    use:'平台查询资讯',
    url:'/mxContentController/findGameDetals',
    params : [`Var param = {platform:’PS4’}`],
    result :[`失败:{code:500,data:null}成功:{200,data:[]  `],
    des :[`处理逻辑 POST请求方式`]
  },
  {
    ...
    params : [`Var param = {gameImg:1} `],
    result :[`失败:{code:500,data:null}成功:{200,data:[]}  `],
    des :[`POST请求方式`]
  },
    {
    use:'查询热门评论',
    url:'/userComment/ findHotComment',
    params : [`无`],
    result :[`失败:{code:500,data:null}成功:{200,data:[ comment_id：“评论ID”， user_id：“用户Id”， comment_text：“评论类容”, comment_grade:”点赞数”, article_type:”类型”, parent_id:”父评论Id”, user_nickname:”评论作者名称”, user_photo:”用户图片”] `],
    des :[`post查询`]
  },
  {
    use:'G币转换成人名币',
    url:'/mxOrderController/gCoinToRmb',
  ...
  {
    use:'人名币转换成G币',
    url:'/mxOrderController/rmbToGCoin',
